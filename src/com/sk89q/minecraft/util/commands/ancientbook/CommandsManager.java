...
import com.sk89q.util.ancientbook.StringUtil;
 ...
 *
 * <p>To mark a method as a command, use {@link com.sk89q.minecraft.util.commands.ancientbook.Command}. For nested commands,
 * see {@link NestedCommand}. To handle permissions, use
 * {@link com.sk89q.minecraft.util.commands.ancientbook.CommandPermissions}.</p>
 *
...
public abstract class CommandsManager<T> {
     ...
     * cached under their respective {@link java.lang.reflect.Method}. The child map has
    ...
    /**
     * Register an class that contains commands (denoted by {@link com.sk89q.minecraft.util.commands.ancientbook.Command}.
     ...
     * class will be registered to be called statically. Otherwise, new
     * instances will be created of the command classes and methods will
     * not be called statically. A List of {@link com.sk89q.minecraft.util.commands.ancientbook.Command} annotations from
     * registered commands is returned.
     *
     * @param cls
     * @return A List of {@link com.sk89q.minecraft.util.commands.ancientbook.Command} annotations from registered commands,
     ...
     * @param player
     * @return
     * @throws com.sk89q.minecraft.util.commands.ancientbook.CommandException
     */
